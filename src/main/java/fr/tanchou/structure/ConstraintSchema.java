...
public class ConstraintSchema extends Schema {
    public ConstraintSchema() {
        ...
        Column key1RefConstraint = new Column("key1RefConstraint", PrimitiveType.KEY,false, false, false, true, false, null);
        Column key2RefConstraint = new Column("key2RefConstraint", PrimitiveType.KEY,false, false, false, true, false, null);
